...
function generateHTML(data) {
  // console.log(colors[data.color].headerBackground, "color");
  return `<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="UTF-8" />
      ...
      <title>Profile for ${data.login}</title>
      </head>
      <body>
    <div class = 'wrapper'>
          ...
          <div class = 'container'>
                  <div class ='col'> 
                      <span class="nav-link">
                          <a target="_blank" href=https://www.google.com/maps/place/${data.location}" class="nav-link"><i class="fas fa-location-arrow"></i> ${data.location}</a>
                          <a target="_blank" href="https://api.github.com/users/${data.login}" class="nav-link"><i class="fab fa-github-square"></i> GitHub</a>
                      </span>
                    ...
                    <div class ='col'> 
                          ...
                          <div class="card mt-2">
                            <div class="card-body">
                              ...
                              <h6 class="card-subtitle mb-2 text-muted">Blog posts on GITHUB</h6>
